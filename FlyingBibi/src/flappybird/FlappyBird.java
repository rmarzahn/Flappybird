...
public class FlappyBird implements ActionListener, KeyListener{
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (Variablen.start == true) {
			...
			if (Variablen.bird.y > Variablen.HEIGHT - 126 || Variablen.bird.y < 0) {
				Variablen.gameOver = true;
			}
	...
	public void repaint(Graphics g) {
		...
		if (Variablen.gameOver && Variablen.started) {
			if (Variablen.score > Variablen.highscore || Variablen.displayhighscore) {
				g.drawString("New HighScore: " + String.valueOf(Variablen.score), 200, 80);
				Variablen.highscore = Variablen.score;
				Variablen.displayhighscore = true;
			}
			else {
